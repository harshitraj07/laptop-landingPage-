...
import styles from "./landingPage.module.css"; // Adjust the path as needed
...
const LandingPage: React.FC = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
    },
    {
      id: 3,
      name: "Student Laptops",
      image:
        "https://images.unsplash.com/photo-1587202372775-e229f1723e1b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
    },
    {
      id: 4,
      name: "Ultrabooks",
  ...
  const products: Product[] = [
    ...
    {
      id: 2,
      name: "DS Computer Business Elite",
      price: 1299,
    ...
    {
      id: 3,
      name: "DS Computer Student Plus",
      price: 799,
      specs: ["i5 Processor", "8GB RAM", "256GB SSD"],
      image:
        "https://images.unsplash.com/photo-1587202372775-e229f1723e1b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
      rating: 4.0,
    },
    ...
    {
      id: 5,
      name: "DS Computer Creator Pro",
      price: 1799,
      specs: ["RTX 3070", "64GB RAM", "2TB SSD"],
      image:
        "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
      rating: 4.8,
    },
    {
      id: 6,
      name: "DS Computer Budget Plus",
      price: 599,
      specs: ["Ryzen 5", "8GB RAM", "256GB SSD"],
      image:
        "https://images.unsplash.com/photo-1629131726692-1accd0c53ce0?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
      rating: 3.9,
    },
  ];
  ...
  const reviews: Review[] = [
    {
      ...
      comment:
        "The DS Computer Pro Gamer exceeded all my expectations. The performance is incredible!",
      rating: 5,
    },
    {
      id: 2,
      ...
      comment: "Lightweight and powerful. Perfect for my design work.",
      rating: 4.5,
    },
    {
      id: 3,
      ...
      comment:
        "Great battery life and the keyboard is so comfortable to type on.",
      rating: 4,
    },
    {
      id: 4,
      ...
      comment: "Fast delivery and excellent customer service. Will buy again!",
      rating: 5,
    },
  ];
        ...
        <div className={styles.navContainer}>
          ...
          >
            <span className={styles.logoText}>
              DS<span className={styles.logoHighlight}>Computer</span>
            </span>
          </motion.div>
        ...
        <div className={styles.heroContent}>
          ...
          >
            <h1 className={styles.heroTitle}>
              Unleash Your{" "}
              <span className={styles.heroTitleHighlight}>Performance</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Discover the perfect laptop for work, play, and everything in
              between.
            </p>
            <motion.div
        ...
        <div className={styles.container}>
          ...
          >
            ...
            <p className={styles.sectionDescription}>
              Find the perfect laptop for your needs from our wide selection of
              categories
            </p>
          </motion.div>
      ...
      >
        <div className={styles.container}>
          ...
          >
            ...
            <p className={styles.sectionDescription}>
              Check out our best-selling laptops with cutting-edge technology
            </p>
          </motion.div>
        ...
        <div className={styles.container}>
          ...
          >
            <h2 className={`${styles.sectionTitle} ${styles.lightTitle}`}>
              Why Choose DS Computer?
            </h2>
            <p
              className={`${styles.sectionDescription} ${styles.lightDescription}`}
            >
              We provide the best service and products to meet all your
              computing needs
            </p>
          </motion.div>
      ...
      <footer id="contact" className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.footerGrid}>
            <div className={styles.footerColumn}>
              <h3 className={styles.footerLogo}>
                DS<span className={styles.footerLogoHighlight}>Computer</span>
              </h3>
              <p className={styles.footerText}>
                Providing high-quality laptops for every need since 2015.
              </p>
            ...
            <div className={styles.footerColumn}>
              ...
              <ul className={styles.footerContactList}>
                <li className={styles.contactItem}>
                  ...
                  <span>
                    Plot 146, 146, Sector 44, Gurugram, Haryana 122003
                  </span>
                </li>
                <li className={styles.contactItem}>
                  <span className={styles.contactIcon}>📞</span>
          ...
          <div className={styles.footerBottom}>
            <p>
              © {new Date().getFullYear()} DS Computer. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
